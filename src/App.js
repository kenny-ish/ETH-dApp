...
const App = () => {
  ...
  const contractAddress = "0x09bE16354575C9e10Ccd2CC3c3c36146FDd02F5B";
  ...
  const checkIfWalletIsConnected = async () => {
    try {
      ...
      if (!ethereum) {
        ...
        console.log("We have the ethereum object", ethereum.selectedAddress);
      }
    ...
    try {
      ...
      if (ethereum) {
        ...
        if (contractBalance_post.lt(contractBalance)) {
          ...
          console.log("User did not win ETH");
        }
        console.log("Contract Balance after Txn: ", ethers.utils.formatEther(contractBalance_post)); 
      } else {
        console.log("Ethereum object doesn't exist!");
      }
    } catch (error) {
  ...
  return (
    <div className="mainContainer">
      <div className="dataContainer">
        ...
        <div className="bio">
          Connect your wallet and 50% chance to win 0.001 ETH! Say 
          <span role="img" aria-label="hand-wave">
            👋
          </span>
